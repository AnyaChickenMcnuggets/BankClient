...
import com.example.bankclient.adapter.CheckIEAdapter;
import com.example.bankclient.database.DatabaseHelper;
import com.example.bankclient.interface_helper.ItemClickListener;
 ...
 * Use the {@link CheckShortExpenseFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CheckShortExpenseFragment extends Fragment implements ItemClickListener {
    ...
    public CheckShortExpenseFragment() {
     ...
     * @return A new instance of fragment CheckShortExpenseFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CheckShortExpenseFragment newInstance(String param1, String param2) {
        CheckShortExpenseFragment fragment = new CheckShortExpenseFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_check_short_expense, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        storeDataInArray();
        CheckIEAdapter adapter = new CheckIEAdapter(rv.getContext(), shortExpenseList, viewModel, this);
