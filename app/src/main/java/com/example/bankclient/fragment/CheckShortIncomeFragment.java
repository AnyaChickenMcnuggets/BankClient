 ...
 * Use the {@link CheckShortIncomeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CheckShortIncomeFragment extends Fragment implements ItemClickListener {
    ...
    public CheckShortIncomeFragment() {
     ...
     * @return A new instance of fragment CheckShortIncomeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CheckShortIncomeFragment newInstance(String param1, String param2) {
        CheckShortIncomeFragment fragment = new CheckShortIncomeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_check_short_income, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        storeDataInArray();
        CheckIEAdapter adapter = new CheckIEAdapter(rv.getContext(), shortIncomeList, viewModel, this);
